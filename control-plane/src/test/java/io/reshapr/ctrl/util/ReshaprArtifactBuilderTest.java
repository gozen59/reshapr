...
class ReshaprArtifactBuilderTest {
   ...
   void testMissingKind() {
      URL promptsURL = getClass().getResource("/io/reshapr/ctrl/util/prompts-missing-kind.yaml");
   ...
   void testUnsupportedArtifactKind() {
      URL promptsURL = getClass().getResource("/io/reshapr/ctrl/util/prompts-unsupported-kind.yaml");
      File promptsFile = new File(promptsURL.getFile());
   ...
   void testNonConformantPrompts() {
      URL promptsURL = getClass().getResource("/io/reshapr/ctrl/util/prompts-invalid.yaml");
      File promptsFile = new File(promptsURL.getFile());
   ...
   void testValidParsingOfPrompts() {
      URL promptsURL = getClass().getResource("/io/reshapr/ctrl/util/prompts-valid.yaml");
      File promptsFile = new File(promptsURL.getFile());
   ...
   void testNonConformantCustomTools() {
      URL customToolsURL = getClass().getResource("/io/reshapr/ctrl/util/custom-tools-invalid.yaml");
   ...
   void testValidParsingCustomTools() {
      URL customToolsURL = getClass().getResource("/io/reshapr/ctrl/util/custom-tools-valid.yaml");
      File customToolsFile = new File(customToolsURL.getFile());
   ...
   void testNonConformantResources() {
      URL customToolsURL = getClass().getResource("/io/reshapr/ctrl/util/resources-invalid.yaml");
      File customToolsFile = new File(customToolsURL.getFile());
   ...
   void testNonConformantResourcesWithTwoContents() {
      URL customToolsURL = getClass().getResource("/io/reshapr/ctrl/util/resources-invalid-two-contents.yaml");
      File customToolsFile = new File(customToolsURL.getFile());
   ...
   void testValidParsingResources() {
      URL resourcesURL = getClass().getResource("/io/reshapr/ctrl/util/resources-valid.yaml");
   ...
   void testValidParsingResourceTemplates() {
      URL resourcesURL = getClass().getResource("/io/reshapr/ctrl/util/resources-templates-valid.yaml");
      File resourcesFile = new File(resourcesURL.getFile());
   ...
   void testValidParsingAllResources() {
      URL resourcesURL = getClass().getResource("/io/reshapr/ctrl/util/resources-all-valid.yaml");
      File resourcesFile = new File(resourcesURL.getFile());
